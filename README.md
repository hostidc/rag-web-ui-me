...
All services (MySQL, ChromaDB, MinIO, Backend, Frontend, Nginx) run in a single container.
...
docker run -d --name rag-web-ui -p 80:80 -p 9000:9000 -p 9001:9001 --env-file .env rag-web-ui:latest
```
...
- [Single Container README](README.single-container.md)
- [Migration Guide from Docker Compose](MIGRATION.md)

---

#### Option 2: Docker Compose (Multi-Container, Recommended for Development)

Traditional multi-container setup with separate services.
